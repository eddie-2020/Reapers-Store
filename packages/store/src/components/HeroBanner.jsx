...
export default function HeroBanner({ onShopClick }) {
  return (
    <div className="relative w-full overflow-hidden min-h-100">
      <picture>
        <source media="(min-width: 768px)" srcSet="/hero.jpeg" />
        <img
          src="/hero2.jpeg"
          alt="REAPERS Premium Fashion"
          className="w-full h-auto md:h-125 md:object-cover md:object-top"
        />
      </picture>
      ...
      <div className="absolute inset-0 flex items-center">
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-5xl">
            ...
            >
              Shop Collection
              <FaArrowRight className="w-0 opacity-0 group-hover:w-4 group-hover:opacity-100 transition-all duration-300 -translate-x-2.5 group-hover:translate-x-0" />
            </button>
          </div>
        </div>
      </div>

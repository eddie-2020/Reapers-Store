...
//   // ... rest of your existing ProductCard code

//   return (
//     <div 
//       className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 cursor-pointer"
...
//         {/* Rest of your existing image navigation code */}
